...
def updateSellerShipmentData(jsonData):
    ...
    shipmentSummary = ShipmentDetails(shipment_id=shipmentId, pick_up_point=jsonData["pickUpPoint"],
                                      ...
                                      transport_id=transport["transportId"], transporter_code=transport["transporterCode"],
                                      track_and_trace=transport["trackAndTrace"], salutation_code=customerDetails["salutationCode"],
